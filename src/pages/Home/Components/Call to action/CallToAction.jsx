...
const CallToAction = () => {
    return (
        <div className='bg-[#F07C3D] bg-opacity-10 py-8 mb-48'>
            ...
            <div>
                <div className="my-12 mx-auto container text-center">
                    ...
                    <Link to="/adopt" className="mt-8 inline-block bg-[#F07C3D] text-white text-xl py-3 px-6 rounded-lg hover:bg-[#ef6e29] transition duration-300">Adopt a Pet Today</Link>
                </div>
            </div>
        </div>
    );
