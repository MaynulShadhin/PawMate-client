        ...
        <div className="bg-gray-100 py-20">
            <div className="max-w-4xl mx-auto">
                <div key={donation._id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src={donation.pet_image} alt={donation.petName} className="w-full h-72 object-cover" />
                    <div className="p-6">
                        ...
                        <p className="text-gray-600 mb-2"><span className="font-bold">Max Donation Amount:</span> ${donation.maxDonation}</p>
