                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {donations.map((donation, index) => (
                            <tr key={index}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">${donation.donatedAmount.toFixed(2)}</td>
                                <td className="px-6 py-4 whitespace-nowrap">${donation.maxDonation.toFixed(2)}</td>
                                <td className="px-6 py-4 whitespace-nowrap">{donation.lastDate}</td>
